...
sentencePattern=['originalPattern','MVO','MVpO','OVM','OVpM','VOpM','VpOpM','VMpO','VpMpO','M','OBV','BVO','OVB','VOB','V1','V2','MVpOPassive','MpOVPassive','OVpMPassive']
for index,i in enumerate(dfs['sentence']):
    if not pd.isnull(dfs.loc[index,'v']) :
        scoreDict={}
...
dfs.to_excel("FinalDatasetAutoTextualEntailment.xlsx")